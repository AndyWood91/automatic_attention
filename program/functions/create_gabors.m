...
% this to three values: left, centre, and right
...
% gabor_position = [[50, (screen_dimensions(2, 2) - gabor_size/2), 50 gabor_size, screen(dimensions(2, 2) + gabor_size/2)], ...
%     [screen_dimensions(2, 1) - gabor_size/2), (screen_dimensions(2, 2) - gabor_size/2), 