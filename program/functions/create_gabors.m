...
gabor_position = [50, (screen_centre(2)-gabor_size)/2, 50+gabor_size, ...
    (screen_centre(2)+gabor_size)/2, screen_dimensions(1)-50-gabor_size, ...
    (screen_centre(2)-gabor_size)/2, screen_dimensions(1)-50, ...
    (screen_centre(2)+gabor_size)/2];
