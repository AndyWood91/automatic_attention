function calibPlotData = CalibratePTB(Calib, morder, iter, donts, main_window)


calibrateWin = Screen('OpenOffscreenWindow', main_window, Calib.bkcolor);
...
ms = Calib.BigMark;
for aa = 1:step
    BigMarker(aa,:) = Screen('OpenOffscreenWindow', main_window, Calib.bkcolor, BigMarkerRect);
...
SmallMarker = Screen('OpenOffscreenWindow', main_window, [Calib.bkcolor, 0], SmallMarkerRect); %alpha value of zero to allow transparency when drawing dots on top of each other
...
for i = 1:Calib.points.n
    ...
    for j = 1:step
        ...
        Screen('DrawTexture', main_window, calibrateWin, [], [1 1 1920 1080]);
