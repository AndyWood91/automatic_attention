...
for aa = 1:step
    ...
    Screen('FillOval', BigMarker(aa,:), [0 0 255 255], [BigMarkerCentre-ms/2 BigMarkerCentre-ms/2 BigMarkerCentre+ms/2 BigMarkerCentre+ms/2], ms);
    Screen('FrameOval', BigMarker(aa,:), [0 0 0 255], [BigMarkerCentre-ms/2 BigMarkerCentre-ms/2 BigMarkerCentre+ms/2 BigMarkerCentre+ms/2], 1);
...
Screen('FillOval', SmallMarker, [255 0 0 255], [], Calib.SmallMark);
