...
Calib.points.x = [0.2 0.8 0.5 0.8 0.2];  % X coordinates in [0,1] coordinate system 
Calib.points.y = [0.2 0.2 0.5 0.8 0.8];  % Y coordinates in [0,1] coordinate system 
...
Calib.fgcolor = [0 1 1]; % (Foreground) color used in calibration process
Calib.fgcolor2 = [1 0.2 0]; % Color used in calibratino process when a second foreground color is used (Calibration dot)
